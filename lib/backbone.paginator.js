...
(function() {
  ...
  // Require jQuery, if we are on the server and it's not present
  var $ = root.jQuery;
  if (!$ && (typeof require !== 'undefined')) {
    $ = require('jquery-browserify');
  }

  // Require Underscore, if we are on the server and it's not present
  var _ = root._;
  if (!_ && (typeof require !== 'undefined')) {
    _ = require('underscore');
  }

  // Require Backbone, if we are on the server and it's not present
